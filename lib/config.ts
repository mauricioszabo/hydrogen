const Config = {
  ...
  schema: {
    ...
    autocompleteSuggestionPriority: {
      ...
      description:
        "Specify the sort order of Hydron's autocomplete suggestions. Note the default providers like snippets have priority of `1`.",
      type: "integer",
      default: 3,
      order: 1,
    },
    ...
    statusBarKernelInfo: {
      ...
      description:
        "If enabled, more detailed kernel information (execution count, execution time if available) will be shown in the Hydron status bar. This requires the above **Disable the Hydron status bar** setting to be `false` to work.",
      type: "boolean",
      default: true,
      order: 6,
    },
    ...
    autoScroll: {
      ...
      includeTitle: false,
      description:
        "If enabled, Hydron will automatically scroll to the bottom of the result view.",
      type: "boolean",
      default: true,
      order: 8,
    },
    ...
    wrapOutput: {
      ...
      includeTitle: false,
      description:
        "If enabled, your output code from Hydron will break long text and items.",
      type: "boolean",
      default: false,
      order: 10,
    },
