...
export type KernelGatewayOptions = Parameters<typeof ServerConnection["makeSettings"]>[0];
export type MinimalServerConnectionSettings = Pick<KernelGatewayOptions, "baseUrl">;
