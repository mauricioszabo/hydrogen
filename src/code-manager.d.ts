...
import type { HydronCellType } from "./hydrogen";
...
export declare function getMetadataForRow(editor: TextEditor, anyPointInCell: Point): HydronCellType;
...
export declare function isComment(editor: TextEditor, position: Point): any;
