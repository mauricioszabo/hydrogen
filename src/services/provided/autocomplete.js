...
function provideAutocompleteResults(store) {
    const autocompleteProvider = {
        ...
        inclusionPriority: 1,
        suggestionPriority: atom.config.get("hydron.autocompleteSuggestionPriority"),
        excludeLowerPriority: false,
        suggestionDetailsEnabled: atom.config.get("hydron.showInspectorResultsInAutocomplete"),
    ...
    store.subscriptions.add(atom.config.observe("hydron.autocomplete", (v) => {
