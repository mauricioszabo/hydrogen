...
exports.consumeStatusBar = exports.consumeAutocompleteWatchEditor = exports.provideAutocompleteResults = exports.provideHydron = exports.deactivate = exports.activate = exports.config = void 0;
...
function activate() {
    ...
    store_1.default.subscriptions.add(atom.config.onDidChange("hydron.languageMappings", ({ newValue, oldValue }) => {
    ...
    store_1.default.subscriptions.add(atom.config.observe("hydron.statusBarDisable", (newValue) => {
        store_1.default.setConfigValue("hydron.statusBarDisable", Boolean(newValue));
    }), atom.config.observe("hydron.statusBarKernelInfo", (newValue) => {
        store_1.default.setConfigValue("hydron.statusBarKernelInfo", Boolean(newValue));
    }));
    store_1.default.subscriptions.add(atom.commands.add("atom-text-editor:not([mini])", {
        ...
        "hydron:toggle-watches": () => atom.workspace.toggle(utils_1.WATCHES_URI),
        ...
        "hydron:toggle-inspector": () => commands.toggleInspector(store_1.default),
        "hydron:interrupt-kernel": () => handleKernelCommand({
            command: "interrupt-kernel",
        }, store_1.default),
        "hydron:restart-kernel": () => handleKernelCommand({
            command: "restart-kernel",
        }, store_1.default),
        "hydron:shutdown-kernel": () => handleKernelCommand({
            command: "shutdown-kernel",
        }, store_1.default),
        "hydron:clear-result": () => result.clearResult(store_1.default),
        "hydron:export-notebook": () => (0, export_notebook_1.exportNotebook)(),
        "hydron:fold-current-cell": () => foldCurrentCell(),
        "hydron:fold-all-but-current-cell": () => foldAllButCurrentCell(),
        "hydron:clear-results": () => result.clearResults(store_1.default),
    }));
    store_1.default.subscriptions.add(atom.commands.add("atom-workspace", {
        "hydron:import-notebook": import_notebook_1.importNotebook,
    }));
    if (atom.inDevMode()) {
        store_1.default.subscriptions.add(atom.commands.add("atom-workspace", {
            "hydron:hot-reload-package": () => (0, utils_1.hotReloadPackage)(),
        }));
    }
