...
const Config = {
    getJson(key, _default = {}) {
        const value = atom.config.get(`hydron.${key}`);
        ...
        try {
            ...
            const message = `Your Hydron config is broken: ${key}`;
    ...
    schema: {
        ...
        autocompleteSuggestionPriority: {
            ...
            description: "Specify the sort order of Hydron's autocomplete suggestions. Note the default providers like snippets have priority of `1`.",
            type: "integer",
            default: 3,
            order: 1,
        },
        showInspectorResultsInAutocomplete: {
            ...
            description: "If enabled, Hydron will try to show [the results from kernel inspection](https://nteract.gitbooks.io/hydrogen/docs/Usage/GettingStarted.html#hydrogen-toggle-inspector) in each autocomplete suggestion's description. ⚠ May slow down the autocompletion performance. (**Note**: Even if you disable this, you would still get autocomplete suggestions.)",
            type: "boolean",
            default: false,
            order: 2,
        },
        importNotebookURI: {
            ...
            description: "If enabled, opening a file with extension `.ipynb` will [import the notebook](https://nteract.gitbooks.io/hydrogen/docs/Usage/NotebookFiles.html#notebook-import) file's source into a new tab. If disabled, or if the Hydron package is not activated, the raw file will open in Atom as normal.",
            type: "boolean",
            default: true,
            order: 3,
        },
        ...
        statusBarKernelInfo: {
            title: "Detailed kernel information in the Hydron status bar",
            description: "If enabled, more detailed kernel information (execution count, execution time if available) will be shown in the Hydron status bar. This requires the above **Disable the Hydron status bar** setting to be `false` to work.",
            type: "boolean",
            default: true,
            order: 6,
        },
        ...
        autoScroll: {
            ...
            includeTitle: false,
            description: "If enabled, Hydron will automatically scroll to the bottom of the result view.",
            type: "boolean",
            default: true,
            order: 8,
        },
        ...
        wrapOutput: {
            ...
            includeTitle: false,
            description: "If enabled, your output code from Hydron will break long text and items.",
            type: "boolean",
            default: false,
            order: 10,
        },
