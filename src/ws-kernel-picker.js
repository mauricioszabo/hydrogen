    ...
    async toggle(_kernelSpecFilter) {
        ...
        if ((0, isEmpty_1.default)(gateways)) {
            atom.notifications.addError("No remote kernel gateways available", {
                description: "Use the Hydron package settings to specify the list of remote servers. Hydron can use remote kernels on either a Jupyter Kernel Gateway or Jupyter notebook server.",
            });
            return;
        }
