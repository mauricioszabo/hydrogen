...
import HydronKernel from "./plugin-api/hydrogen-kernel";
import type { HydronKernelMiddlewareThunk, HydronKernelMiddleware } from "./plugin-api/hydrogen-types";
...
declare class MiddlewareAdapter implements HydronKernelMiddlewareThunk {
    _middleware: HydronKernelMiddleware;
    _next: MiddlewareAdapter | KernelTransport;
    constructor(middleware: HydronKernelMiddleware, next: MiddlewareAdapter | KernelTransport);
...
export default class Kernel {
    ...
    pluginWrapper: HydronKernel | null;
    ...
    addMiddleware(middleware: HydronKernelMiddleware): void;
